...
<html>
 ...
 <body>
      ...
      <div class="gtco-container">
        ...
        <div class="row">
          <div class="col-sm-4 col-xs-12">
            <div id="gtco-logo"><a href="modules/backend/admin.php">Admin</a></div>
          </div>
          <div class="col-xs-8 text-right menu-1">
            <div id="gtco-logo"><a href="">APLIKASI ABSENSI BERBASIS WEB</a></div>
          </div>
        </div>
    ...
    <header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url(assets/background/.jpg)" data-stellar-background-ratio="0.5" >
          ...
          <div class="col-md-14 col-md-offset-0 text-left">
            <div class="row row-mt-10em">
              <div style="margin-top: 200px" class="col-md-15 mt-text animate-box" data-animate-effect="fadeInUp">
                ...
                ?>
                <center><a href="modules/frontend/absensi-pengajian.php?idPengajian=<?php echo $v["id"] ?>"<h2 style="font-size: 45px" class="cursive-font"><?php echo $v["namaPengajian"] ?></h2> </center>
                <?php } ?>
              </div>
