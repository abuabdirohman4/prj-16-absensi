...
if ( isset($_POST["submit"]) ){
  ...
  if($a == 1 && $exist->num_rows <= 0){
      ...
      ?><script type="text/javascript">location.href = 'berhasil.php?idPengajian=<?php echo $dataPengajian["id"] ?>';</script><?php
      ...
      <div class="gtco-container">
        ...
        <div class="row">
          <div class="col-sm-4 col-xs-12">
            <div id="gtco-logo"><a href="index.php"><?php echo $dataPengajian["namaPengajian"] ?></a></div>
          </div>
